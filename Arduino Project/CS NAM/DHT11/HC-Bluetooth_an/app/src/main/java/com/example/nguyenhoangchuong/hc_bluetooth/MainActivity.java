...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewH = (TextView) findViewById(R.id.textView4);
    ...
    private void display(String rawData) {
        try {
            String[] tmp = rawData.split(" ");
            textViewH.setText(tmp[0].trim() + "°C");
            textViewD.setText(tmp[1].trim() + "% ");
        } catch (Exception e) {

            textViewH.setText("00.00°C");
            textViewD.setText("00.00% ");
        }
    }
